...
![img](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9tbWJpei5xcGljLmNuL21tYml6X3BuZy91SkRBVUtyR0M3TERraHJEbDRIOVRxWmh3eWVOU2VhTkl5QzV0Ym93ZmxIeVJJVFBLdmdBeVNmM0FaSmliRVVUclNvM2Z6Um04NVZEZkluWjJvbGtJZ2cvNjQw?x-oss-process=image/format,png)

目前市面上较知名的发行版有：Ubuntu、RedHat、CentOS、Debian、Fedora、SuSE、OpenSUSE、Arch Linux、SolusOS 等。

![img](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9tbWJpei5xcGljLmNuL21tYml6X3BuZy91SkRBVUtyR0M3TERraHJEbDRIOVRxWmh3eWVOU2VhTjdabk9CZmwzVjEwQnV0RmFSVnRuQmFzSWw5cnI4cWlhaWJ2YVFiN2lhQ2xQcHV4ZURGcEh5ZWliSFEvNjQw?x-oss-process=image/format,png)
...
![img](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9tbWJpei5xcGljLmNuL21tYml6X3BuZy91SkRBVUtyR0M3TDFJNzJDMUhyd0o5Ykc2WEFiVmdnTTRSc1F1RWFvTUk3OGdyM2pHeGtWSDdPTld5REhtcmVtT0hpYVVpYmMzc3FQUmZFdVZ1SHFpY2ZxQS82NDA?x-oss-process=image/format,png)
...
![img](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9tbWJpei5xcGljLmNuL21tYml6X3BuZy91SkRBVUtyR0M3TDFJNzJDMUhyd0o5Ykc2WEFiVmdnTUl4Vm9EeVE0TFd4U2JIRGpBWWZIdUlkN3hmSEhpY2h0cVpLMmVoc1h2Y0M5S2lhaWJQZjY4czlkZy82NDA?x-oss-process=image/format,png)
...
这个时候，键盘上除了 Esc 这个按键之外，其他的按键都可以视作为一般的输入按钮了，所以你可以进行任何的编辑。**按下 ESC 按钮回到一般模式**
...
# [Linux安装JDK详细步骤(rpm方式)](https://www.cnblogs.com/endtel/p/4894283.html)
...
选择想要下载的版本，这里我选择的是jdk1.8.0_251
选择对应系统版本，本教程针对的是 Linux x64 Compressed Archive版安装

# 3.传入ECS服务器

将下载的压缩包通过xftp传入ecs服务器
目录位置：usr/java

vf jdk-8u251-linux-x64.tar.gz
1
命令介绍：
tar　　　　　　备份文件
-zxvf　　　　　
